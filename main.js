...
const totalEvens = sumEvens.reduce((a, b) => a + b)
console.log(`The sum is ${totalEvens}`)
...
const weatherStates = weather.map(w => w.weather_state_name)
//console.log(weatherStates);
const newWeather = weatherStates.filter((value, index) => weatherStates.indexOf(value) === index)

console.log(newWeather)

//find the id of the object in weather that has a min_temp of 15.915
const idealTemp = weather.filter(temp => temp.min_temp === 15.915)[0].id


console.log(`ID is: ${idealTemp}`)
